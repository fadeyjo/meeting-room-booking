...
import { useAuth, useGetMeQuery, useGetMyBookingsQuery } from '@mrb/store';
            ...
            {isAuthenticated && (
              <>
                {isDemo ? (
                  ...
                  <span
                    className="text-sm text-ink-secondary hidden sm:inline"
                    title={`${me.lastName} ${me.firstName} · мои брони: ${myBookings.length}`}
                  >
